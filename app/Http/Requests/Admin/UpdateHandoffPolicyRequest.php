...
class UpdateHandoffPolicyRequest extends FormRequest
{
    ...
    {
        $policyId = $this->route('handoff_policy')?->id ?? $this->route('policy')?->id;
        ...
        return [
            ...
            'reason_code' => [
                ...
                'string',
                'max:100',
                Rule::unique('handoff_policies', 'reason_code')->ignore($policyId),
            ],
            ...
            'rules.*.id' => ['nullable', 'integer', 'exists:handoff_policy_rules,id'],
